...
addpath('C:\Users\pcadm\Documents\Git Repositeries\Plasticity') % add the path to your make_db file
...
ops0.toolbox_path = 'C:\Users\pcadm\Documents\Git Repositeries\Suite2P';
...
ops0.diameter               = 10; % most important parameter. Set here, or individually per experiment in make_db file

% ---- root paths for files and temporary storage (ideally an SSD drive. my SSD is C:/)
ops0.RootStorage            = 'C:\Users\pcadm\Documents\Git Repositeries\Plasticity'; % Suite2P assumes a folder structure, check out README file
ops0.temp_tiff              = 'C:\Users\pcadm\Documents\Git Repositeries\Plasticity\temp.tif'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = 'C:\Users\pcadm\Documents\Git Repositeries\Plasticity';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = 'C:\Users\pcadm\Documents\Git Repositeries\Plasticity\results'; % a folder structure is created inside
